<?php include 'pg_sp_admin_db.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Educatalysts- Programming Uploads</title>    
...
<div class="main_box">
    ...
    <div class="main">
        <div class="navbar">
            ...
            <div class="menu">
                <ul class="navbar-2">
                    ...
                    <li><a href="pg_sp_admin_dwnld.php">DOWNLOAD</a></li>
        ...
        <div class="content">
            <h1>Upload & Download<br><span>Programming </span> <br>Files here</h1>
           
                <div class="form">
                    <h2>Upload Programming Sample Paper</h2>
                    <form action="pg_sp_admin_dwnld.php" method="post" enctype="multipart/form-data">
                        <br>
                      <input type="file" name="myfile"> 
                    <br>
                      <button type="submit" class="btnn" name="save">Upload</a></button>
                       <br>
                      <p class="link">Want to Download Programming Sample Paper?<br>
                      <br>
                      <a href="pg_sp_admin_dwnld.php">Download Programming Sample Paper </a> here</a></p>
