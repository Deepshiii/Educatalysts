        ...
        <div class="navbar">
            ...
            <div class="menu">
                <ul class="navbar-2">
                    ...
                    <li><a href="neet_notes_admin_upload.php">UPLOAD</a></li>
          ...
          <tbody>
               <?php foreach($files as $file): ?>
                  <tr>
                      ...
                      <td>
                          <a style="text-decoration: none;"href="neet_notes_admin_dwnld.php?file_id=<?php echo $file['id']?>"><button class="download_button">Download</a></button>
                      </td>
                  </tr>
                     <?php endforeach ;?>
          </tbody>
