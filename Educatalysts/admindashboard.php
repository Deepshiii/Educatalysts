...
<html lang="en" dir="ltr">
  <head>
    ...
    <title> Educatalysts-Admin Dashboard</title>
    ...
    <div class="col">
        ...
        <button class="dropdbtn">JEE</button>
								<div class="dropdown-content">
									<a href="jeeuploadadmin.php">Notes</a>
									<!-- <a href="#">Video</a> -->
									<a href="jee_sp_admin_upload.php">Sample Paper</a>
        ...
        <button class="dropdbtn">JEE ADVANCED</button>
								<div class="dropdown-content">
									<a href="advnc_notes_admin_upload.php">Notes</a>
									<!-- <a href="#">Video</a> -->
									<a href="advnc_sp_admin_upload.php">Sample Paper</a>
         ...
         <div class="dropdown">
          <button class="dropdbtn">PROGRAMMING</button>
                  <div class="dropdown-content">
                    <a href="pg_notes_admin_upload.php">Notes</a>
                    <!-- <a href="#">Video</a> -->
                    <a href="pg_sp_admin_upload.php">Sample Paper</a>
           ...
           <div class="dropdown">
            <button class="dropdbtn">NEET</button>
                    <div class="dropdown-content">
                      <a href="neet_notes_admin_upload.php">Notes</a>
                      <!-- <a href="#">Video</a> -->
                      <a href="neet_sp_admin_upload.php">Sample Paper</a>
             ...
             <div class="dropdown">
              <button class="dropdbtn">NDA</button>
                      <div class="dropdown-content">
                        <a href="nda_notes_admin_upload.php">Notes</a>
                        <!-- <a href="#">Video</a> -->
                        <a href="nda_sp_admin_upload.php">Sample Paper</a>
                      
                      </div>
               </div>
         <!-- size and color and hover -->
         <!-- <button>and more...</button> -->
    </div>
    <div class="col">
      <div class="card">
          <!-- <h5>Knowledge is the only Treasure that increases on sharing solden
