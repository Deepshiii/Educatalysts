...
<head>
    ...
    <title>Educatalysts- JEE Videos</title>
...
<div class="main_box">
    ...
    <div class="main">
        ...
        <div class="content">
            <h1>Watch <br><span>JEE Videos</span> <br>here</h1>  
     ...
     <table>
         ...
         <tbody>
                ...
                <tr>
                     <td>1</td>
                     <td> <a style="text-decoration:none;" href="https://youtu.be/YwdFvjqmBRM"> <button class="button">PROBABILITY</button></a></td>
                </tr>
                <tr>
                     <td>2</td>
