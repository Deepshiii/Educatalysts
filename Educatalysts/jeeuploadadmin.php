<?php include 'jeeadmindatabase.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="main">
        <div class="navbar">
            ...
            <div class="menu">
                <ul class="navbar-2">
                    ...
                    <li><a href="jeedownloadsadmin.php">DOWNLOAD</a></li>
        ...
        <div class="content">
            <h1>Upload & <br><span>Download JEE</span> <br>Files here</h1>
                ...
                <div class="form">
                    <h2>Upload JEE Files</h2>
                    <form action="jeedownloadsadmin.php" method="post" enctype="multipart/form-data">
                        <br>
                      <input type="file" name="myfile"> 
                    <br>
                      <button type="submit" class="btnn" name="save">Upload</a></button>
                       <br>
                      <p class="link">Want to Download JEE Files?<br>
                      <br>
                      <a href="jeedownloadsadmin.php">Download JEE Files </a> here</a></p>
