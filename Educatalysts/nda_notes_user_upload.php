<?php include 'nda_notes_user_db.php'; ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="main">
      <div class="navbar">
        ...
        <div class="menu">
          <ul class="navbar-2">
            ...
            <li><a href="nda_notes_user_dwnld.php">DOWNLOAD</a></li>
      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <form action="nda_notes_user_dwnld.php" method="post" enctype="multipart/form-data">
            <br>
            ...
            <p class="link">Want to Download NDA Notes?<br>
              <br>
              <a href="nda_notes_user_dwnld.php">Download NDA Notes </a> here</a>
            </p>
