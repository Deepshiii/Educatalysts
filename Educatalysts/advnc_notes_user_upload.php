<?php include 'advnc_notes_user_db.php'; ?>
<!DOCTYPE html>
<html lang="en">

<head>
  <title>Educatalysts- JEE Uploads</title>
    ...
    <div class="main">
      <div class="navbar">
        ...
        <div class="menu">
          <ul class="navbar-2">
            ...
            <li><a href="advnc_notes_user_dwnld.php">DOWNLOAD</a></li>
      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <form action="advnc_notes_user_dwnld.php" method="post" enctype="multipart/form-data">
            <br>
            ...
            <p class="link">Want to Download JEE Advance Notes?<br>
              <br>
              <a href="advnc_notes_user_dwnld.php">Download JEE Advance Notes </a> here</a>
            </p>
