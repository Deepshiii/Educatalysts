<?php include 'jeeuserdatabse.php'; ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="main">
      <div class="navbar">
        ...
        <div class="menu">
          <ul class="navbar-2">
            ...
            <li><a href="jeedownloaduser.php">DOWNLOAD</a></li>
      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <form action="jeedownloaduser.php" method="post" enctype="multipart/form-data">
            <br>
            ...
            <p class="link">Want to Download JEE Files?<br>
              <br>
              <a href="jeedownloaduser.php">Download JEE Files </a> here</a>
            </p>
