<?php include 'advnc_sp_user_db.php'; ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="main">
      <div class="navbar">
        ...
        <div class="menu">
          <ul class="navbar-2">
            ...
            <li><a href="advnc_sp_user_dwnld.php">DOWNLOAD</a></li>
      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <form action="advnc_sp_user_dwnld.php" method="post" enctype="multipart/form-data">
            <br>
            ...
            <p class="link">Want to Download JEE Advance Sample Paper?<br>
              <br>
              <a href="advnc_sp_user_dwnld.php">Download JEE Advance Sample Paper </a> here</a>
            </p>
