...
<head>
    ...
    <title>Educatalysts- NEET Videos</title>
...
<div class="main_box">
    ...
    <div class="main">
        ...
        <div class="content">
            <h1>Watch <br><span>NEET Videos</span> <br>here</h1>  
     ...
     <table>
         ...
         <tbody>
                ...
                <tr>
                     <td>1</td>
                     <td> <a style="text-decoration:none;" href="https://youtu.be/CYqG9WVMqC0"> <button class="button">ORGANIC CHEMISTRY</button></a></td>
                </tr>
                <tr>
                     <td>2</td>
                     <td> <a style="text-decoration:none;" href="https://youtu.be/mSBM-jjiApw"> <button class="button">THERMODYNAMICS</button></a></td> 
                </tr>
         </tbody>
              </table>
  </div>
