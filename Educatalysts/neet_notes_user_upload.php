    ...
    <div class="main">
      <div class="navbar">
        ...
        <div class="menu">
          <ul class="navbar-2">
            ...
            <li><a href="neet_notes_user_dwnld.php">DOWNLOAD</a></li>
      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <form action="neet_notes_user_dwnld.php" method="post" enctype="multipart/form-data">
            <br>
            ...
            <p class="link">Want to Download NEET Notes?<br>
              <br>
              <a href="neet_notes_user_dwnld.php">Download NEET Notes </a> here</a>
            </p>
