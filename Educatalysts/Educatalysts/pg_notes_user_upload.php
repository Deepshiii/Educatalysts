<?php include 'pg_notes_user_db.php'; ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="main_box">
    ...
    <div class="main">
      <div class="navbar">
        ...
        <div class="menu">
          <ul class="navbar-2">
            ...
            <li><a href="pg_notes_user_dwnld.php">DOWNLOAD</a></li>
      ...
      <div class="content">
        ...
        <div class="form">
          <h2>Upload Programming Notes</h2>
          <form action="pg_notes_user_dwnld.php" method="post" enctype="multipart/form-data">
            <br>
            <input type="file" name="myfile">
            <br>
            <button type="submit" class="btnn" name="save">Upload</a></button>
            <br>
            <p class="link">Want to Download Programming Notes?<br>
              <br>
              <a href="pg_notes_user_dwnld.php">Download Programming Notes </a> here</a>
            </p>
