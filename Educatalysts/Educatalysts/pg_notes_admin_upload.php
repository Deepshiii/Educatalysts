        ...
        <div class="navbar">
            ...
            <div class="menu">
                <ul class="navbar-2">
                    ...
                    <li><a href="pg_notes_admin_dwnld.php">DOWNLOAD</a></li>
        ...
        <div class="content">
            <h1>Upload & Download<br><span>Programming</span> <br>Files here</h1>
                ...
                <div class="form">
                    ...
                    <form action="pg_notes_admin_dwnld.php" method="post" enctype="multipart/form-data">
                        <br>
                    ...
                    <br>
                      ...
                      <br>
                      <a href="pg_notes_admin_dwnld.php">Download Programming Notes</a> here</a></p>
