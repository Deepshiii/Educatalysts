...
<body>
  <div class="main_box">
    ...
    <div class="content">
      <div class="col">
        <h1>Educatalysts</h1>
        <p>Looking materials for particular course ?<br> Choose Course to Upload and Download Files.</p>
        <div class="dropdown">
      ...
      <div class="col">
        <div class="card">
          ...
          <p>Knowledge is the only Treasure that increases on sharing solden
