<?php include 'advnc_sp_admin_db.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Educatalysts- JEE Advance Uploads</title>    
...
<div class="main_box">
    ...
    <div class="main">
        <div class="navbar">
            ...
            <div class="menu">
                <ul class="navbar-2">
                    ...
                    <li><a href="advnc_sp_admin_dwnld.php">DOWNLOAD</a></li>
        ...
        <div class="content">
            <h1>Upload &<br><span>Download JEE </span> <br>Advance Files here</h1>
           
                <div class="form">
                    <h2>Upload JEE Advance Sample Paper</h2>
                    <form action="advnc_sp_admin_dwnld.php" method="post" enctype="multipart/form-data">
                        <br>
                      <input type="file" name="myfile"> 
                    <br>
                      <button type="submit" class="btnn" name="save">Upload</a></button>
                       <br>
                      <p class="link">Want to Download JEE Advance Sample Paper?<br>
                      <br>
                      <a href="advnc_sp_admin_dwnld.php">Download JEE Advance Sample Paper </a> here</a></p>
