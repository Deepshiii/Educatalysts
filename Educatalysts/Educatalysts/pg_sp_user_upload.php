    ...
    <div class="main">
      <div class="navbar">
        ...
        <div class="menu">
          <ul class="navbar-2">
            ...
            <li><a href="pg_sp_user_dwnld.php">DOWNLOAD</a></li>
      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <form action="pg_sp_user_dwnld.php" method="post" enctype="multipart/form-data">
            <br>
            ...
            <p class="link">Want to Download Programming Sample Paper?<br>
              <br>
              <a href="pg_sp_user_dwnld.php">Download Programming Sample Paper </a> here</a>
            </p>
