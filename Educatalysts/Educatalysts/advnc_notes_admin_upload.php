<?php include 'advnc_notes_admin_db.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="main">
        <div class="navbar">
            ...
            <div class="menu">
                <ul class="navbar-2">
                    ...
                    <li><a href="advnc_notes_admin_dwnld.php">DOWNLOAD</a></li>
        ...
        <div class="content">
            <h1>Upload &<br><span>Download JEE </span> <br>Advance Files here</h1>
                ...
                <div class="form">
                    <h2>Upload JEE Advance Notes</h2>
                    <form action="advnc_notes_admin_dwnld.php" method="post" enctype="multipart/form-data">
                        <br>
                      <input type="file" name="myfile"> 
                    <br>
                      <button type="submit" class="btnn" name="save">Upload</a></button>
                       <br>
                      <p class="link">Want to Download JEE Advance Notes?<br>
                      <br>
                      <a href="advnc_notes_admin_dwnld.php">Download JEE Advance Notes</a> here</a></p>
