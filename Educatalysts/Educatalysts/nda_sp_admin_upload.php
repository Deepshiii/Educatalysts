<?php include 'nda_sp_admin_db.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Educatalysts- NDA Uploads</title>    
...
<div class="main_box">
    ...
    <div class="main">
        <div class="navbar">
            ...
            <div class="menu">
                <ul class="navbar-2">
                    ...
                    <li><a href="nda_sp_admin_dwnld.php">DOWNLOAD</a></li>
        ...
        <div class="content">
            <h1>Upload &<br><span>Download NDA</span> <br>Files here</h1>
           
                <div class="form">
                    <h2>Upload NDA Sample Paper</h2>
                    <form action="nda_sp_admin_dwnld.php" method="post" enctype="multipart/form-data">
                        <br>
                      <input type="file" name="myfile"> 
                    <br>
                      <button type="submit" class="btnn" name="save">Upload</a></button>
                       <br>
                      <p class="link">Want to Download NDA Sample Paper?<br>
                      <br>
                      <a href="nda_sp_admin_dwnld.php">Download NDA Sample Paper </a> here</a></p>
