<?php include 'neet_sp_admin_db.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="main">
        <div class="navbar">
            ...
            <div class="menu">
                <ul class="navbar-2">
                    ...
                    <li><a href="neet_sp_admin_dwnld.php">DOWNLOAD</a></li>
        ...
        <div class="content">
            <h1>Upload &<br><span>Download NEET</span> <br>Files here</h1>
                ...
                <div class="form">
                    <h2>Upload NEET Sample Paper</h2>
                    <form action="neet_sp_admin_dwnld.php" method="post" enctype="multipart/form-data">
                        <br>
                      <input type="file" name="myfile"> 
                    <br>
                      <button type="submit" class="btnn" name="save">Upload</a></button>
                       <br>
                      <p class="link">Want to Download NEET Sample Paper?<br>
                      <br>
                      <a href="neet_sp_admin_dwnld.php">Download NEET Sample Paper </a> here</a></p>
