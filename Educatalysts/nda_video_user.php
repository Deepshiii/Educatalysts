...
<head>
    ...
    <title>Educatalysts- NDA Videos</title>
...
<div class="main_box">
    ...
    <div class="main">
        ...
        <div class="content">
            <h1>Watch <br><span>NDA Videos</span> <br>here</h1>  
     ...
     <table>
         ...
         <tbody>
                ...
                <tr>
                     <td>1</td>
                     <td> <a style="text-decoration:none;" href="https://youtu.be/Rn7CbIgqSBs"> <button class="button">CURRENT AFFAIRS</button></a></td>
                </tr>
                <tr>
                     <td>2</td>
                     <td> <a style="text-decoration:none;" href="https://youtu.be/NS39r6aWwIw"> <button class="button">TRIGNOMETRY</button></a></td> 
                </tr>
         </tbody>
              </table>
  </div>
