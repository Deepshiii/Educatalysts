...
<head>
    ...
    <title>Educatalysts- JEE Advance Videos</title>
...
<div class="main_box">
    ...
    <div class="main">
        ...
        <div class="content">
            <h1>Watch <br><span>JEE Advance</span> <br>Videos here</h1>  
     ...
     <table>
         ...
         <tbody>
                ...
                <tr>
                     <td>1</td>
                     <td> <a style="text-decoration:none;" href="https://youtu.be/Kc_X7iKEnXI"> <button class="button">SOLID STATES</button></a></td>
                </tr>
                <tr>
                     <td>2</td>
                     <td> <a style="text-decoration:none;" href="https://youtu.be/x8f0DYrrd60"> <button class="button">CALCULUS</button></a></td> 
                </tr>
         </tbody>
              </table>
  </div>
